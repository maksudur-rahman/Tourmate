...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    void getlatlong() {
        ...
        String addressStr = name+", Bangladesh";
        ...
        switch(v.getId())
        {
           /* case R.id.B_search:
            ...
            case R.id.B_atm:
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(MapsActivity.this, "Showing Nearby ATM Booths", Toast.LENGTH_SHORT).show();
                break;
    ...
    private String getUrl(double latitude , double longitude , String nearbyPlace)
    {
        ...
        googlePlaceUrl.append("&key="+"AIzaSyDYSWL3ozVPXXhnmV60Z0Yp1oP-abrKdno");
