...
public class EventAdapter extends ArrayAdapter<Event>{
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        takaIV.setImageResource(R.mipmap.editicon);
        takaIV.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent =new Intent(getContext(),EventActivity.class);
                intent.putExtra("id",eventArrayList.get(position).getEventID());
                intent.putExtra("name",eventArrayList.get(position).getDesName());
                intent.putExtra("fDate",eventArrayList.get(position).getFromaDate());
                intent.putExtra("tDate",eventArrayList.get(position).getToDate());
                intent.putExtra("estBudget",eventArrayList.get(position).getBudget());
